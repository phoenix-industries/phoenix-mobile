...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  final TextEditingController _nameController =
      TextEditingController(text: "Frank Castle");
  final TextEditingController _emailController =
      TextEditingController(text: "punisher124@gmail.com");
  final TextEditingController _phoneController =
      TextEditingController(text: "0102658568895");
        ...
        ? Image.file(
           ...
           : const Center(
            child: Text(
              ...
              items: [
              "Cairo", "Alexandria", "Port Said", "Suez", "Giza", "Damietta",
              "Dakahlia", "Sharqia", "Qalyubia", "Kafr El Sheikh", "Gharbia",
              "Monufia", "Beheira", "Ismailia", "Beni Suef", "Fayoum", "Minya",
